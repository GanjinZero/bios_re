...
def read():
    ...
    # cid tid str
    for idx, line in enumerate(open("/platform_tect/wikidata/Concepts 2021-11-05.txt", "r", encoding = "utf-8")):
        if idx == 0:
            continue
    ...
    for idx, line in enumerate(tqdm(open("/platform_tect/wikidata/wiki_sentence_1125/triplets_1119.txt", "r", encoding = "utf-8"))):
        if idx == 0:
            continue
